...
(2, 'Tobias', 19,'noviembre-2021' ,'TOB040608K67')
(3, 'Tobias', 21,'diciembre-2021' ,'TOB040608K67')
(4, 'Tobias', 21,'enero-2022' ,'TOB040608K67')
(5, 'Tobias', 22,'febrero-2022' ,'TOB040608K67')
SELECT * FROM Employe;
...
(2, 1, NOW(), 'Avenida siempre viva', 'Hamburguesa angus')
(3, 3, NOW(), 'Avenida siempre viva', 'Hamburguesa hawaiana')
(4, 2, NOW(), 'Avenida siempre viva', 'Hamburguesa vegetariana')
(5, 5, NOW(), 'Avenida siempre viva', 'aros de cebolla')
